...
const zhHans: Partial<Translations> = {
  ...
  'accountError.noAccount': '未找到已登录账号，请先登录。',
  'accountError.invalidAccount': '保存的账号无效，请重新添加。',
  'accountError.read': '无法读取账号配置。',
  'accountError.write': '无法保存账号配置，请检查文件权限。',
  'accountError.format': '账号配置或响应格式错误。',
  'accountError.keychain': '无法访问系统凭据存储。',
  'accountError.network': '请求失败，请检查网络或代理设置。',
  'accountError.quotaTimeout': '额度刷新超时，请检查网络或代理设置。',
  'accountError.denied': '此账号无权访问额度服务。',
  'accountError.rateLimited': '请求过于频繁，请稍后重试。',
  'accountError.unavailable': '额度服务暂时不可用，请稍后重试。',
  'accountError.quota': '暂时无法读取账号额度，请稍后重试。',
  'accountError.code': '请粘贴浏览器返回的完整授权码。',
  'accountError.state': '授权与本次登录不匹配，请重新登录。',
  'accountError.cancelled': '授权已取消，请重新添加账号。',
  'accountError.expired': '授权已超时，请重新添加账号。',
  'accountError.busy': '正在完成授权。',
  'accountError.auth': '授权失败，请检查授权码或重新添加账号。',
  'accountError.authResponse': '授权响应不完整或格式错误，请重新登录。',
  'accountError.ports': '登录回调端口被占用，请关闭其他登录窗口后重试。',
  'accountError.browser': '无法打开授权页面。',
  'accountError.rollback': '切换失败，且无法恢复原账号配置。',
  'accountError.complete': '已收到授权',
  'accountError.closeWindow': '可以关闭此窗口，返回 EchoBird。',
  'accountError.callbackFailed': '授权失败，请返回 EchoBird 重试。',
  ...
  'mother.hintUnlockCodexPlugins': '帮我安装 ChatGPT 汉化插件',
