...
// currently carries a URL, so each renders as a single plain-text chunk
// today; the linkify machinery is kept for future hints that reintroduce a
// URL. The split stops at
